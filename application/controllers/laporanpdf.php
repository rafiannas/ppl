...
class Laporanpdf extends CI_Controller
{
    ...
    function index()
    {
        ...
        $pdf->Cell(20, 6, 'Jam Mulai', 1, 0);
        $pdf->Cell(22, 6, 'Jam Selesai', 1, 0);
        $pdf->Cell(15, 6, 'kursi', 1, 0);
        ...
        foreach ($mahasiswa as $row) {
            $pdf->Cell(20, 6, $row->nim_user, 1, 0);
            $pdf->Cell(25, 6, $row->nama_user, 1, 0);
            $pdf->Cell(34, 6, $row->nama_lab, 1, 0);
            $pdf->Cell(20, 6, $row->tanggal_pinjam, 1, 0);
            $pdf->Cell(20, 6, $row->jam_mulai, 1, 0);
            $pdf->Cell(22, 6, $row->jam_selesai, 1, 0);
            $pdf->Cell(15, 6, $row->tempat_duduk, 1, 0);
